...
const PRODUCTS = [
  {
    ...
    price: 19.99,
    images: ["/img/products/prov-flag1.jpg", "/img/products/product-1-thumb1.svg", "/img/products/product-1.svg"],
    sizes: ["90x60"],
    category: "banderas",
    brand: "MiTaller",
    colors: ["Blanco", "Negro"],
  ...
  },
  {
    ...
    price: 14.99,
    images: ["/img/products/prov-tshirt1.jpg", "/img/products/product-2-thumb1.svg", "/img/products/product-2.svg"],
    sizes: ["S/M", "M/L"],
    category: "gorras",
    brand: "MiTaller",
  ...
  },
  {
    ...
    price: 7.5,
    images: ["/img/products/prov-patch1.jpg", "/img/products/product-3-thumb1.svg", "/img/products/product-3.svg"],
    sizes: ["10x6cm", "15x9cm"],
    category: "accesorios",
    brand: "MiTaller",

 ...
 * Uso: node scripts/generate-feed.js
...
function main() {
  ...
  console.log(`   Sube a GMC: https://merchants.google.com → Product feed → URL ${BASE_URL}/feeds/noctip_products.xml`)
}

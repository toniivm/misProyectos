        ...
        <>
          ...
          <div className="fixed inset-0 z-[80] flex items-center justify-center p-4">
            <motion.div
              ...
              className="relative max-h-[calc(100vh-2rem)] w-full max-w-sm overflow-y-auto rounded-2xl bg-white p-8 shadow-2xl"
            >
              <button
                onClick={closeModal}
                ...
                {mode === 'login' && (
                  <div className="flex justify-end">
                    <button
                      ...
                      disabled={loading}
                      className="text-xs font-semibold text-gray-500 transition hover:text-gray-900 disabled:opacity-60"
                    >
                      {t('forgotPassword')}
                    </button>
                  </div>

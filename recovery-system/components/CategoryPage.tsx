...
const CATEGORY_EDITORIAL: Record<string, {
  ...
  all: {
    eyebrow: { en: 'Noctip store', es: 'Tienda Noctip' },
    title: { en: 'Everything you need to sleep better and recover faster.', es: 'Todo lo que necesitas para dormir mejor y recuperarte más rápido.' },
    copy: { en: 'Shop by the problem you feel: snoring, bad posture, or neck pain. Each product is designed to solve one specific problem — and solve it well.', es: 'Compra por el problema que sientes: ronquidos, mala postura o dolor de cuello. Cada producto está diseñado para resolver un problema específico — y resolverlo bien.' },
    needs: { en: ['Stop snoring', 'Fix posture', 'Relieve neck pain', 'Daily recovery'], es: ['Dejar de roncar', 'Mejorar postura', 'Aliviar dolor cervical', 'Recuperación diaria'] },
    highlights: [`${CATALOG.length} products`, '3 problem categories', '30-night guarantee'],
  },
  'sleep-audio': {
    eyebrow: { en: 'Sleep & Anti-Snoring', es: 'Sueño y Anti-Ronquidos' },
    title: { en: 'Stop snoring. Start sleeping.', es: 'Deja de roncar. Empieza a dormir.' },
    copy: { en: 'Anti-snoring mouthpieces and sleep audio gear that open your airway, eliminate snoring, and help you get the quiet rest you deserve. Your partner will thank you.', es: 'Férulas anti-ronquidos y equipo de audio para dormir que abren tu vía aérea, eliminan los ronquidos y te ayudan a descansar en silencio. Tu pareja te lo agradecerá.' },
    needs: { en: ['Snoring relief', 'Jaw alignment', 'Quiet sleep', 'Partner peace'], es: ['Alivio de ronquidos', 'Alineación mandibular', 'Sueño silencioso', 'Pareja tranquila'] },
    highlights: ['Jaw advancement tech', 'Custom moldable fit', 'Medical-grade silicone'],
  },
  'neck-recovery': {
    eyebrow: { en: 'Posture & Recovery', es: 'Postura y Recuperación' },
    title: { en: 'Fix your posture. Free your neck.', es: 'Mejora tu postura. Libera tu cuello.' },
    copy: { en: 'Posture correctors and cervical massagers designed for desk workers who need real relief from slouching, tension, and screen fatigue. Results in 2 weeks.', es: 'Correctores posturales y masajeadores cervicales diseñados para quienes trabajan sentados y necesitan alivio real del encorvamiento y la tensión. Resultados en 2 semanas.' },
    needs: { en: ['Desk workers', 'Posture correction', 'Spine alignment', 'Pain relief'], es: ['Trabajo de escritorio', 'Corrección postural', 'Alineación de columna', 'Alivio del dolor'] },
    highlights: ['Y-shaped support', 'XS to XL sizes', 'Invisible under clothes'],
  },
  sensory: {
    eyebrow: { en: 'Cervical Massage', es: 'Masaje Cervical' },
    title: { en: 'Pulse therapy that adapts to your neck.', es: 'Terapia por pulsos que se adapta a tu cuello.' },
    copy: { en: 'Cervical pulse massagers with floating electrodes that conform to your neck curves. Relief at your desk, at home, or on the go. Results from the first use.', es: 'Masajeadores cervicales por pulsos con electrodos flotantes que se adaptan a las curvas de tu cuello. Alivio en el trabajo, en casa o donde sea. Resultados desde el primer uso.' },
    needs: { en: ['Neck tension', 'Desk relief', 'Travel comfort', 'Daily massage'], es: ['Tensión cervical', 'Alivio en escritorio', 'Comodidad de viaje', 'Masaje diario'] },
    highlights: ['Floating electrodes', 'Auto-adapting design', 'One-button simplicity'],
  },
}

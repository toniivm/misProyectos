...
const COPY = {
  en: {
    ...
    whyNoctip: {
      ...
      body: 'Sleeping well, relieving tension, and recovering your body shouldn\'t be complicated or expensive. We created Noctip because we saw too many people suffering and settling for products that didn\'t work. So we designed our own. Simple. Effective. Backed by real guarantees.',
    },
    bestseller: {
      badge: 'Most popular',
      heading: 'Noctip Halo',
      sub: 'Your nights, transformed. The Halo gently advances your jaw to open your airway, stopping snoring at the source.',
      price: '€17.99',
      comparePrice: '€29.99',
      savings: '40% off',
      cta: 'Shop now',
    ...
    guarantees: {
      ...
      items: [
        { icon: RotateCcw, title: '30-night trial', text: 'Try any product for 30 nights. If it doesn\'t work, we arrange a free return and full refund.' },
        { icon: Truck, title: 'Free shipping', text: 'Every order ships free within Europe. We dispatch within 24 hours.' },
        { icon: ShieldCheck, title: 'Secure payments', text: 'All transactions through Stripe with 256-bit SSL encryption.' },
        { icon: Headphones, title: 'Real support', text: 'A real person responds within 24 hours. No bots.' },
      ],
    },
    reviews: {
      heading: 'What our customers say',
      items: [
        { name: 'María G.', product: 'Noctip Rest', rating: 5, comment: 'I\'ve been using it for a week and I sleep like never before. I put on a podcast and fall asleep in minutes.', verified: true },
        ...
        { name: 'Laura M.', product: 'Noctip Rest', rating: 5, comment: 'The fabric is soft and doesn\'t squeeze. Battery lasts all night. Highly recommended.', verified: true },
        { name: 'Carlos R.', product: 'Noctip Back', rating: 5, comment: 'Skeptical at first, but the difference is brutal. In two weeks my back pain is gone.', verified: true },
      ],
    },
    faq: {
      ...
      items: [
        ...
        { q: 'What does the 30-night guarantee cover?', a: 'Try any product for 30 nights. If it doesn\'t meet your expectations, we arrange a free return and full refund.' },
  ...
  es: {
    ...
    whyNoctip: {
      ...
      body: 'Dormir bien, aliviar tensiones y recuperar tu cuerpo no debería ser complicado ni caro. Creamos Noctip porque vimos a demasiadas personas sufriendo y conformándose con productos que no funcionaban. Así que diseñamos los nuestros. Simples. Efectivos. Respaldados por garantías reales.',
    },
    bestseller: {
      badge: 'Más popular',
      heading: 'Noctip Halo',
      sub: 'Tus noches, transformadas. El Halo avanza suavemente tu mandíbula para abrir las vías respiratorias, eliminando los ronquidos de raíz.',
      price: '€17.99',
      comparePrice: '€29.99',
      savings: '40% dto.',
      cta: 'Comprar ahora',
    ...
    guarantees: {
      heading: 'Compra con tranquilidad',
      items: [
        { icon: RotateCcw, title: '30 noches de prueba', text: 'Prueba cualquier producto 30 noches. Si no funciona, devolución y reembolso completo.' },
        { icon: Truck, title: 'Envío gratis', text: 'Todo pedido se envía gratis dentro de Europa. Despachamos en 24 horas.' },
        { icon: ShieldCheck, title: 'Pagos seguros', text: 'Transacciones por Stripe con cifrado SSL de 256 bits.' },
        { icon: Headphones, title: 'Soporte real', text: 'Una persona real responde en menos de 24 horas.' },
      ],
    },
    reviews: {
      heading: 'Lo que dicen nuestros clientes',
      items: [
        { name: 'María G.', product: 'Noctip Rest', rating: 5, comment: 'Llevo una semana usándola y duermo como nunca. Me pongo un podcast y me quedo dormida en minutos.', verified: true },
        { name: 'Javier P.', product: 'Noctip Halo', rating: 5, comment: 'Primera noche y no ronqué. Mi mujer no lo podía creer. Llevaba años intentando de todo.', verified: true },
        { name: 'Laura M.', product: 'Noctip Rest', rating: 5, comment: 'La tela es suave y no aprieta. La batería dura toda la noche. Muy recomendada.', verified: true },
        { name: 'Carlos R.', product: 'Noctip Back', rating: 5, comment: 'Escéptico al principio, pero la diferencia es brutal. En dos semanas se me quitó el dolor de espalda.', verified: true },
      ],
    },
    faq: {
      ...
      items: [
        ...
        { q: '¿Qué cubre la garantía de 30 noches?', a: 'Prueba cualquier producto durante 30 noches. Si no funciona, gestionamos la devolución y el reembolso completo.' },
    ...
    cta: {
      heading: '¿Listo para descansar mejor?',
      ...
      <main className="pb-24 sm:pb-0">
        ...
        <section className="py-16 sm:py-24 lg:py-28 bg-[#0d1219]">
          <div className="mx-auto max-w-[720px] px-4 sm:px-6 text-center">
            <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <h2 className="text-[clamp(1.6rem,4vw,2.8rem)] font-bold tracking-[-0.04em] text-[#f6f2eb] leading-[1.1]">{copy.whyNoctip.heading}</h2>
              <p className="mt-5 sm:mt-6 text-[14px] sm:text-[16px] leading-[1.8] text-[#b8c4d0]">{copy.whyNoctip.body}</p>
            </motion.div>
          </div>
        </section>
              ...
              <motion.div initial={{ opacity: 0, x: 24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                <div className="relative rounded-3xl overflow-hidden border border-white/[0.08] bg-[#0d1219] shadow-[0_20px_60px_rgba(0,0,0,0.4)]">
                  <div className="relative aspect-square overflow-hidden">
                    <img src={flagshipImage} alt={getLocalizedProductName(flagship, locale)}
                      onError={(e) => { (e.target as HTMLImageElement).style.display = 'none' }}
                      className="absolute inset-0 h-full w-full object-contain p-8 sm:p-12 transition-transform duration-700 hover:scale-[1.03]" />
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              {copy.guarantees.items.map((item, idx) => (
                <motion.div key={item.title} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
                  ...
                  className="group rounded-2xl border border-white/[0.06] bg-[#111720] p-5 sm:p-6 transition-all duration-300 hover:border-[#10BFD8]/20">
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div>
                      <h3 className="text-[14px] sm:text-[16px] font-bold text-[#f2eee7] mb-1">{item.title}</h3>
                      <p className="text-[12px] sm:text-[14px] leading-[1.6] text-[#8791a1]">{item.text}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
        ...
        <section className="py-14 sm:py-24 lg:py-28 bg-[#0d1219]">
          <div className="mx-auto max-w-[720px] px-4 sm:px-6">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              className="text-center mb-10 sm:mb-12">
              <h2 className="text-[clamp(1.3rem,4vw,2rem)] font-bold tracking-[-0.03em] text-[#f2eee7]">{copy.faq.heading}</h2>
            </motion.div>
        ...
        <section className="py-14 sm:py-24 lg:py-28">
          <div className="mx-auto max-w-[640px] px-4 sm:px-6 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <h2 className="text-[clamp(1.5rem,4vw,2.8rem)] font-bold tracking-[-0.04em] text-[#f6f2eb]">{copy.cta.heading}</h2>
              <p className="mt-3 sm:mt-4 text-[14px] sm:text-[16px] text-[#6b7785]">{copy.cta.sub}</p>
              <div className="mt-8 sm:mt-10">
                <Link href={`/${locale}/shop/all`}
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-9 py-4.5 text-[16px] font-bold text-[#080c12] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_8px_40px_rgba(255,255,255,0.15)] min-h-[56px]">

...
const SHOP_HOME_COPY = {
    ...
    problemCards: [
      {
        ...
        description:
          'Bluetooth sleep headbands, white noise machines and nasal strips. Fall asleep faster, stay asleep longer.',
        slug: 'sleep-audio',
        colorFrom: '#0d1828',
        colorTo: '#0c1520',
        borderColor: '#1e3a5f',
      ...
      },
      {
        ...
        description:
          'Cervical traction devices, targeted massagers and posture correctors. Undo hours at a desk in 20 minutes.',
        slug: 'neck-recovery',
        colorFrom: '#0d1f1a',
        colorTo: '#0c1520',
        borderColor: '#1a3d2e',
      ...
      },
      {
        ...
        description:
          'Percussion massage guns, vibration massagers and heating pads. Pro-level recovery at home.',
      ...
      },
      {
        ...
        description:
          'Compact travel pillows, portable massagers and complete sleep kits. Quality rest wherever you land.',
        slug: 'travel',
        colorFrom: '#101828',
        colorTo: '#0c1520',
        borderColor: '#1e3550',
  ...
  es: {
    ...
    starterRoutines: [
      ...
      {
        title: 'Recuperación de escritorio',
        slug: 'neck-recovery',
        accent: '🦴',
        copy: 'Para cuellos rígidos, jornadas cargadas de pantalla y hombros tensos al final del día.',
        picks: ['CerviFlex', 'NeckPulse Pro', 'PostureBand'],
      },
      {
        title: 'Reset de viaje',
        slug: 'travel',
        accent: '✈️',
        copy: 'Para vuelos, noches de hotel y días largos fuera de casa donde la recuperación debe seguir siendo portátil.',
        picks: ['TravelPillow Ultra', 'PortablePulse', 'NapKit Pro'],
      },
    ],
    ...
    problemCards: [
      {
        ...
        description:
          'Bandas Bluetooth para dormir, máquinas de ruido blanco y tiras nasales. Duerme antes y mantente dormido más tiempo.',
        slug: 'sleep-audio',
        colorFrom: '#0d1828',
        colorTo: '#0c1520',
        borderColor: '#1e3a5f',
      ...
      },
      {
        ...
        solution: 'Recuperación cervical',
        description:
          'Dispositivos de tracción cervical, masajeadores focalizados y correctores de postura. Revierte horas de escritorio en 20 minutos.',
        slug: 'neck-recovery',
        colorFrom: '#0d1f1a',
        colorTo: '#0c1520',
        borderColor: '#1a3d2e',
      ...
      {
        emoji: '💆',
        problem: '¿Músculos cansados o doloridos?',
        solution: 'Recuperación muscular',
        description:
          'Pistolas de masaje, masajeadores vibratorios y almohadillas térmicas. Recuperación de nivel pro en casa.',
        slug: 'muscle-recovery',
        colorFrom: '#1a1020',
        colorTo: '#0c1520',
        borderColor: '#3a1f5f',
      ...
      {
        emoji: '✈️',
        problem: '¿Siempre viajando?',
        solution: 'Recuperación de viaje',
        description:
          'Almohadas compactas, masajeadores portátiles y kits completos de descanso. Recupera calidad de sueño donde aterrices.',
        slug: 'travel',
        colorFrom: '#101828',
        colorTo: '#0c1520',
        borderColor: '#1e3550',
    ...
    steps: [
      {
        ...
        text: 'Compra por categoría: sueño, alivio, recuperación muscular o viaje. Cada producto resuelve una necesidad diaria concreta.',
      },
      {
        step: '02',
        icon: '📦',
        title: 'Pídelo hoy, sale mañana',
        text: 'Cada pedido sale en 24 horas con envío gratis y seguimiento. Normalmente llega en 3-5 días dentro de Europa.',
      },
      {
        step: '03',
        icon: '✨',
        title: 'Garantía de 30 noches',
        text: 'Pruébalo durante un mes. Si no notas la diferencia, contáctanos y te devolvemos el dinero. Sin riesgo.',
      },
    ],
    recoveryTag: 'Recuperación práctica',
    recoveryHeading: 'Herramientas premium que encajan en rutinas reales.',
    recoveryBody:
      'La referencia que compartiste funciona porque explica el producto con imágenes, pequeñas pruebas y casos de uso muy claros. Aplicamos esa misma estructura aquí, pero llevada a una marca de recuperación más calmada: menos juguetona, más premium y más centrada en el descanso.',
    recoveryHighlights: [
      {
        title: 'Úsalo cada noche',
        copy: 'Equipos de audio para dormir y antifaces pensados para uso repetido y sin fricción, no para ser un truco puntual.',
      },
      {
        title: 'Lo bastante portátil para viajar',
        copy: 'Productos compactos para aviones, hoteles, post-entreno y pequeños resets entre jornadas largas.',
      },
      {
        title: 'Organizado por problemas reales',
        copy: 'Cada categoría empieza por lo que sientes primero: mal sueño, cuello rígido, músculos cargados o fatiga de viaje.',
      },
    ],
    ...
    viewAll: 'Ver todo',
    bundleTag: 'Ahorra con packs',
    bundleHeading: 'Construye tu sistema completo de recuperación',
    bundleDescription:
      'Combina masaje, alivio cervical y audio para dormir en una sola rutina. Los descuentos se aplican automáticamente en el checkout.',
        ...
        <section className="mb-16 grid gap-5 lg:grid-cols-[minmax(0,0.88fr)_minmax(0,1.12fr)]">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {copy.lifestyleShots.map((shot, index) => (
              <div
                key={shot.title}
                className={`relative overflow-hidden rounded-[28px] border border-white/[0.07] bg-[#10161f] ${index === 0 ? 'min-h-[280px] sm:col-span-2' : 'min-h-[220px]'}`}
              >
                <img src={shot.src} alt={shot.title} className="h-full w-full object-cover" style={{ objectPosition: shot.objectPosition }} />
                <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(8,12,16,0.02),rgba(8,12,16,0.6))]" />
                <div className="absolute inset-x-0 bottom-0 p-4 sm:p-5">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {copy.supportLinks.map((label) => (
                  <li key={label}>
                    <span className="text-[13px] text-[#6b7785]">{label}</span>
                  </li>
                ))}
              </ul>
            </div>
